...
namespace System.Windows
{
    ...
    public partial class LengthConverter : TypeConverter
    {
        ...
        public override bool CanConvertFrom(ITypeDescriptorContext typeDescriptorContext, Type sourceType)
        {
            ...
            if(sourceType == typeof(short) ||sourceType==typeof(ushort) ||sourceType==typeof(int)||sourceType==typeof(uint)||sourceType==typeof(long)||sourceType==typeof(ulong)||sourceType ==typeof(Single )||sourceType==typeof(double )||sourceType ==typeof(decimal ))
            {
                return true;
            }
            return false;
